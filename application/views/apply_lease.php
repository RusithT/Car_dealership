                    ...
                    <div class="col-sm-16 col-md-16 col-lg-12 col-xs-24">
                        <form action="#">
                            <div class="login-form">
                                <h4 class="login-title">Who are you a <b><i>individual</i></b> or a <b><i>company</i></b> ?</h4>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="service-item">
                                        <img src="../assets/images/handshake.jpg" alt="">
                                        <div class="down-content">
                                            <h4>If you are an Individual</h4>
                                            <!-- <div style="margin-bottom:20px;">
                                            <span>from <sup>RS.</sup>4500 per weekend</span>
                                            </div> -->
                                            <a href="<?php echo base_url() ?>index.php/individual_lease" class="filled-button">Click here</a>
                                        </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <img src="../assets/images/handshake.jpg" alt="">
                                        <div class="down-content">
                                            <h4>If you are a Company</h4>
                                            <!-- <div style="margin-bottom:20px;">
                                            <span>from <sup>RS.</sup>4500 per weekend</span>
                                            </div> -->                                            
                                            <a href="<?php echo base_url() ?>index.php/company_lease" class="filled-button">Click here</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="more-info about-info">
      <div class="container">
        <div class="more-info-content">
          ...
          <h6>The decision  to buy a vehicle is one of the most important investment decision you make in your life. That is why yo need to choose a financal iinstitution that you can trust to fulfil leasing needs.</h6></br>
            <h6>We offers that most cinvenient vehicle leaseing solution for you. We ensure that you receive the most efficient service at the shortest time possible with the minimum documentation work involved.</h6><br/><hr/>
