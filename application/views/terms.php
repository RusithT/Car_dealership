...
<body>
    ...
    <div class="container">
      <div class="more-info-content">
        <div class="right-content">
          ...
          <h6>We offers that most cinvenient vehicle leaseing solution for you. We ensure that you receive the most efficient service at the shortest time possible with the minimum documentation work involved.</h6><br />
          <hr />
  ...
  <div class="row">
    ...
    <div class="col-md-2"><a href="<?php echo base_url() ?>index.php/apply_lease" class="filled-button">Apply now</a></div>
    <div class="col-md-1">&nbsp;</div>
    <div class="col-md-4">&nbsp;</div>
  </div>
  <br />
