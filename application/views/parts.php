...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?=base_url();?>assets/assets1/images/favicon.ico">

    <!-- CSS
	============================================ -->

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?=base_url();?>assets/assets1/css/vendor/bootstrap.min.css">
    <!-- Fontawesome -->
    <link rel="stylesheet" href="<?=base_url();?>assets/assets1/css/vendor/font-awesome.css">
    <!-- Fontawesome Star -->
    <link rel="stylesheet" href="<?=base_url();?>assets/assets1/css/vendor/fontawesome-stars.css">
    <!-- Ion Icon -->
    <link rel="stylesheet" href="<?=base_url();?>assets/assets1/css/vendor/ion-fonts.css">
    <!-- Slick CSS -->
    <link rel="stylesheet" href="<?=base_url();?>assets/assets1/css/plugins/slick.css">
    <!-- Animation -->
    <link rel="stylesheet" href="<?=base_url();?>assets/assets1/css/plugins/animate.css">
    <!-- jQuery Ui -->
    <link rel="stylesheet" href="<?=base_url();?>assets/assets1/css/plugins/jquery-ui.min.css">
    <!-- Lightgallery -->
    <link rel="stylesheet" href="<?=base_url();?>assets/assets1/css/plugins/lightgallery.min.css">
    <!-- Nice Select -->
    <link rel="stylesheet" href="<?=base_url();?>assets/assets1/css/plugins/nice-select.css">

    <!-- Vendor & Plugins CSS (Please remove the comment from below vendor.min.css & plugins.min.css for better website load performance and remove css files from the above) -->
    <!--
    <script src="<?=base_url();?>assets/assets1/js/vendor/vendor.min.js"></script>
    <script src="<?=base_url();?>assets/assets1/js/plugins/plugins.min.js"></script>
    -->

    <!-- Main Style CSS (Please use minify version for better website load performance) -->
    <link rel="stylesheet" href="<?=base_url();?>assets/assets1/css/style.css">
    <!--<link rel="stylesheet" href="<?=base_url();?>assets/assets1/css/style.min.css">-->
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="javascript:void(0)">Language <i class="fa fa-chevron-down"></i></a>
                                            <ul class="ht-dropdown">
                                                <li class="active"><a href="javascript:void(0)"><img src="<?=base_url();?>assets/assets1/images/menu/icon/1.jpg" alt="JB's Language Icon">English</a></li>
                                                <li><a href="javascript:void(0)"><img src="<?=base_url();?>assets/assets1/images/menu/icon/2.jpg" alt="JB's Language Icon">Français</a>
                                                </li>
                                            </ul>
                                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 d-block d-lg-none">
                            <div class="header-logo_area header-sticky_logo">
                                <a href="index.html">
                                    <img src="<?=base_url();?>assets/assets1/images/menu/logo/1.png" alt="Uren's Logo">
                                </a>
                            </div>
                        </div>
                        ...
                        <ul class="minicart-list">
                            <li class="minicart-product">
                                ...
                                <div class="product-item_img">
                                    <img src="<?=base_url();?>assets/assets1/images/product/small-size/1.jpg" alt="Uren's Product Image">
                                </div>
                            ...
                            <li class="minicart-product">
                                <a class="product-item_remove" href="javascript:void(0)"><i
                                    class="ion-android-close"></i></a>
                                <div class="product-item_img">
                                    <img src="<?=base_url();?>assets/assets1/images/product/small-size/2.jpg" alt="Uren's Product Image">
                                </div>
                                <div class="product-item_content">
                            ...
                            <li class="minicart-product">
                                <a class="product-item_remove" href="javascript:void(0)"><i
                                    class="ion-android-close"></i></a>
                                <div class="product-item_img">
                                    <img src="<?=base_url();?>assets/assets1/images/product/small-size/3.jpg" alt="Uren's Product Image">
                                </div>
                                <div class="product-item_content">
            ...
            <div class="container">
                <div class="breadcrumb-content">
                    ...
                    <ul>
                        ...
                        <li class="active">Vehicle spare parts</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="sp-img_area">
                                <div class="sp-img_slider slick-img-slider uren-slick-slider" data-slick-options='{
                                    ...
                                    <div class="single-slide red zoom">
                                        <img src="<?=base_url();?>assets/assets1/images/product/large-size/1.jpg" alt="Uren's Product Image">
                                    </div>
                                    <div class="single-slide orange zoom">
                                        <img src="<?=base_url();?>assets/assets1/images/product/large-size/2.jpg" alt="Uren's Product Image">
                                    </div>
                                    <div class="single-slide brown zoom">
                                        <img src="<?=base_url();?>assets/assets1/images/product/large-size/3.jpg" alt="Uren's Product Image">
                                    </div>
                                    <div class="single-slide umber zoom">
                                        <img src="<?=base_url();?>assets/assets1/images/product/large-size/4.jpg" alt="Uren's Product Image">
                                    </div>
                                    <div class="single-slide black zoom">
                                        <img src="<?=base_url();?>assets/assets1/images/product/large-size/5.jpg" alt="Uren's Product Image">
                                    </div>
                                    <div class="single-slide green zoom">
                                        <img src="<?=base_url();?>assets/assets1/images/product/large-size/6.jpg" alt="Uren's Product Image">
                                    </div>
                                </div>
                                <div class="sp-img_slider-nav slick-slider-nav uren-slick-slider slider-navigation_style-4" data-slick-options='{
                                    ...
                                    <div class="single-slide red">
                                        <img src="<?=base_url();?>assets/assets1/images/product/small-size/1.jpg" alt="Uren's Product Thumnail">
                                    </div>
                                    <div class="single-slide orange">
                                        <img src="<?=base_url();?>assets/assets1/images/product/small-size/2.jpg" alt="Uren's Product Thumnail">
                                    </div>
                                    <div class="single-slide brown">
                                        <img src="<?=base_url();?>assets/assets1/images/product/small-size/3.jpg" alt="Uren's Product Thumnail">
                                    </div>
                                    <div class="single-slide umber">
                                        <img src="<?=base_url();?>assets/assets1/images/product/small-size/4.jpg" alt="Uren's Product Thumnail">
                                    </div>
                                    <div class="single-slide red">
                                        <img src="<?=base_url();?>assets/assets1/images/product/small-size/5.jpg" alt="Uren's Product Thumnail">
                                    </div>
                                    <div class="single-slide orange">
                                        <img src="<?=base_url();?>assets/assets1/images/product/small-size/6.jpg" alt="Uren's Product Thumnail">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="sp-content">
                                ...
                                <div class="qty-btn_area">
                                    <ul>
                                        ...
                                        <li><a class="qty-compare_btn" href="compare.html" data-toggle="tooltip" title="Compare This Product"><i class="ion-ios-shuffle-strong"></i></a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/1-1.jpg" alt="Uren's Product Image">
                                                <img class="secondary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/1-2.jpg" alt="Uren's Product Image">
                                            </a>
                                            <div class="sticker">
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/2-1.jpg" alt="Uren's Product Image">
                                                <img class="secondary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/2-2.jpg" alt="Uren's Product Image">
                                            </a>
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/3-1.jpg" alt="Uren's Product Image">
                                                <img class="secondary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/3-2.jpg" alt="Uren's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                            <div class="add-actions">
                                                <ul>
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/4-1.jpg" alt="Uren's Product Image">
                                                <img class="secondary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/4-2.jpg" alt="Uren's Product Image">
                                            </a>
                                            <div class="sticker-area-2">
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/5-1.jpg" alt="Uren's Product Image">
                                                <img class="secondary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/5-2.jpg" alt="Uren's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                            <div class="add-actions">
                                                <ul>
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/6-1.jpg" alt="Uren's Product Image">
                                                <img class="secondary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/6-2.jpg" alt="Uren's Product Image">
                                            </a>
                                            <div class="sticker-area-2">
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/7-1.jpg" alt="Uren's Product Image">
                                                <img class="secondary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/7-2.jpg" alt="Uren's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                            <div class="add-actions">
                                                <ul>
                            ...
                            <div class="product-slide_item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img class="primary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/8-1.jpg" alt="Uren's Product Image">
                                                <img class="secondary-img" src="<?=base_url();?>assets/assets1/images/product/medium-size/1-2.jpg" alt="Uren's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                            <div class="add-actions">
                        ...
                        "slidesToShow": 6
                            ...
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="<?=base_url();?>assets/assets1/images/brand/1.jpg" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="<?=base_url();?>assets/assets1/images/brand/2.jpg" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="<?=base_url();?>assets/assets1/images/brand/3.jpg" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="<?=base_url();?>assets/assets1/images/brand/4.jpg" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="<?=base_url();?>assets/assets1/images/brand/5.jpg" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="<?=base_url();?>assets/assets1/images/brand/6.jpg" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-item">
                                <div class="inner-slide">
                                    <div class="single-product">
                                        <a href="javascript:void(0)">
                                            <img src="<?=base_url();?>assets/assets1/images/brand/7.jpg" alt="Uren's Brand Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="footer-widgets_info">
                                <div class="footer-widgets_logo">
                                    <a href="#">
                                        <img src="<?=base_url();?>assets/assets1/images/menu/logo/1.png" alt="Uren's Footer Logo">
                                    </a>
                                </div>
                    ...
                    <div class="footer-bottom_nav">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="payment">
                                    <a href="#">
                                        <img src="<?=base_url();?>assets/assets1/images/footer/payment/1.png" alt="Uren's Payment Method">
                                    </a>
                                </div>
                            </div>
                        </div>
...
============================================ -->
    ...
    <!-- jQuery JS -->
    <script src="<?=base_url();?>assets/assets1/js/vendor/jquery-1.12.4.min.js"></script>
    <!-- Modernizer JS -->
    <script src="<?=base_url();?>assets/assets1/js/vendor/modernizr-2.8.3.min.js"></script>
    <!-- Popper JS -->
    <script src="<?=base_url();?>assets/assets1/js/vendor/popper.min.js"></script>
    <!-- Bootstrap JS -->
    <script src="<?=base_url();?>assets/assets1/js/vendor/bootstrap.min.js"></script>

    <!-- Slick Slider JS -->
    <script src="<?=base_url();?>assets/assets1/js/plugins/slick.min.js"></script>
    <!-- Barrating JS -->
    <script src="<?=base_url();?>assets/assets1/js/plugins/jquery.barrating.min.js"></script>
    <!-- Counterup JS -->
    <script src="<?=base_url();?>assets/assets1/js/plugins/jquery.counterup.js"></script>
    <!-- Nice Select JS -->
    <script src="<?=base_url();?>assets/assets1/js/plugins/jquery.nice-select.js"></script>
    <!-- Sticky Sidebar JS -->
    <script src="<?=base_url();?>assets/assets1/js/plugins/jquery.sticky-sidebar.js"></script>
    <!-- Jquery-ui JS -->
    <script src="<?=base_url();?>assets/assets1/js/plugins/jquery-ui.min.js"></script>
    <script src="<?=base_url();?>assets/assets1/js/plugins/jquery.ui.touch-punch.min.js"></script>
    <!-- Lightgallery JS -->
    <script src="<?=base_url();?>assets/assets1/js/plugins/lightgallery.min.js"></script>
    <!-- Scroll Top JS -->
    <script src="<?=base_url();?>assets/assets1/js/plugins/scroll-top.js"></script>
    <!-- Theia Sticky Sidebar JS -->
    <script src="<?=base_url();?>assets/assets1/js/plugins/theia-sticky-sidebar.min.js"></script>
    <!-- Waypoints JS -->
    <script src="<?=base_url();?>assets/assets1/js/plugins/waypoints.min.js"></script>
    <!-- jQuery Zoom JS -->
    <script src="<?=base_url();?>assets/assets1/js/plugins/jquery.zoom.min.js"></script>
