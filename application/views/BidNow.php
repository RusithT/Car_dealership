                            ...
                            <tr>
                                ...
                                <th scope="col">
                                    <div class="form-group">
                                        <br>
                                        <center> <a href="<?php echo base_url() ?>Login" onclick="document.location='default.asp'"><button type="button" class="btn btn-primary btn-lg btn-block">Confirm Bid</button></a> </center>
                                        <br>
                                    </div>
                                </th>
                            </tr>
